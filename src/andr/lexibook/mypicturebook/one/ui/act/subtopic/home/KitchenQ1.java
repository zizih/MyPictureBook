...
public class KitchenQ1 extends HomeBase {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        al_bg.setBackgroundDrawable(getResources().getDrawable(R.drawable.fr__q01_my_home_kitchen_01));
        ll_fg.setBackgroundDrawable(getResources().getDrawable(R.drawable.fr_my_home_kitchen_01_image_normal));
