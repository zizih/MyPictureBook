...
public class KitchenQ3 extends HomeBase {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        al_bg.setBackgroundDrawable(getResources().getDrawable(R.drawable.fr__q03_my_home_kitchen_03a_bkg));
        ll_fg.setBackgroundDrawable(getResources().getDrawable(R.drawable.fr__q03_my_home_kitchen_03a_image_normal));
    ...
    private void toQ3B() {
        ...
        al_bg.setBackgroundDrawable(getResources().getDrawable(R.drawable.fr__q03_my_home_kitchen_03b_bkg));
        ll_fg.setBackgroundDrawable(getResources().getDrawable(R.drawable.fr__q03_my_home_kitchen_03b_image_normal));
